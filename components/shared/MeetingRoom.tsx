...
const MeetingRoom = () => {
  ...
  return (
    <section className="text-dark100_light900 relative w-full overflow-hidden text-white">
      ...
      <div className="flex-center flex w-full">
        <div className="fixed bottom-0 flex flex-row items-center justify-center gap-5">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="border-dark-500 bg-dark-500 text-white">
